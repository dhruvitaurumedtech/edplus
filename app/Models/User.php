...
class User extends Authenticatable implements JWTSubject
{
    ...
    protected $fillable = [
        'unique_id', 'firstname', 'lastname', 'email', 'email_verified_at', 'mobile', 'otp_num', 'password', 'image', 'role_type', 'country', 'state', 'city', 'pincode', 'address', 'dob', 'school_name', 'area', 'employee_type', 'qualification',
    ];
