...
class TopicController extends Controller
{
    ...
    public function index()
    {
        ...
        $topics = Topic_model::
        join('base_table','topic.base_table_id','=','base_table.id')
        ...
        ->leftjoin('medium','medium.id','=','base_table.medium')
        ->leftjoin('board','board.id','=','base_table.board')
        ->select('subject.name as subject','chapters.chapter_name','stream.name as sname','standard.*','medium.name as medium',
        'board.name as board','base_table.id as base_id','chapters.id as chapter_id',
