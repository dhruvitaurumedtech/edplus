...
Route::middleware(['auth:api', 'apilogs'])->group(function () {
    ...
    Route::post('/institute/student-reject-convert', [InstituteApiController::class, 'get_accept_request_convert'])->name('reject.request_list.get')->middleware('check.permission:11,4');
    ...
    Route::post('institute/student-fees-calculation2', [InstituteApiController::class, 'student_fees_calculation2']);
    ...
    Route::post('/institute/change-role', [StaffController::class, 'change_role'])->middleware('check.permission:27,1');
    ...
    Route::post('/institute/return-product', [ProductAndInventoryController::class, 'return_product']);
    Route::post('/institute/product-assign-list', [ProductAndInventoryController::class, 'product_assign_list']);
    //remainder
    ...
    Route::post('/institute/assign-inventory', [ProductAndInventoryController::class, 'assign_inventory']);
